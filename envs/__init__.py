# .venv/lib/python3.11/site-packages/mani_skill/envs/tasks/tabletop/__init__.py
...
from .pick_cylinder import PickCylinderEnv
...
from .empty_tabletop import EmptyTabletopEnv